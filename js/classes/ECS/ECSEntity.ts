...
export class ECSEntity {
     ...
     *
     * @param {ECSComponent} componentInstance - The component instance to add
     ...
     * ```
     */
    addComponent(componentInstance: ECSComponent) {
     ...
     * ```
     */
    getComponent<T extends ECSComponent>(componentType: {
        new (...args: any[]): T;
    }): T | undefined {
     ...
     */
    hasComponent<T extends ECSComponent>(componentType: {
        new (...args: any[]): T;
    }): boolean {
